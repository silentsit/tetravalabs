    ...
    <section className="page-container space-y-6 py-6 pb-20 sm:space-y-8 sm:py-8 sm:pb-24 lg:pb-28">
      ...
      <div>
        ...
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-[#475569]">
          Pay by card, Wise, or cryptocurrency. Card checkout opens in a new tab after you place the
          order. Wise and crypto charge on their own pages. All orders require RUO
          acknowledgment before fulfillment.{" "}
