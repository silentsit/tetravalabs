    ...
    <LegalPageShell title="Shipping Information" pathname="/shipping">
      <div className="space-y-6 text-sm leading-relaxed text-[#475569]">
        ...
        <section className="space-y-3">
          ...
          <p>
            Shipping is free on all orders worldwide. Customs, duties, and import fees remain the
            recipient&apos;s responsibility. The rate is confirmed at checkout before payment.
          </p>
          <ul className="list-disc space-y-2 pl-5">
