...
const OVERVIEWS = {
  ...
  mazdutide: [
    "Buy {productName} peptide online from Tetrava Labs. Mazdutide is a dual GLP-1/glucagon receptor agonist researched in next-generation incretin and energy-expenditure metabolic models.",
...
async function run() {
  ...
  const missingBuy = handles.filter((h) => !/^Buy \{productName\}( peptide)? online/.test(OVERVIEWS[h][0]))
