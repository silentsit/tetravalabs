...
const recommendedProduction = [
  ...
  { key: "R2_BUCKET", file: "medusa", label: "Cloudflare R2 bucket for COA PDFs" },
  { key: "R2_PUBLIC_BASE_URL", file: "medusa", label: "Public base URL for COA files on R2" },
  { key: "TYPESENSE_HOST", file: "storefront", label: "Typesense host for live storefront search" },
  { key: "TYPESENSE_API_KEY", file: "storefront", label: "Typesense search API key" },
